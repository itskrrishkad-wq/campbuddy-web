    ...
    <section id="packages-section" className="py-24 bg-stone-50 text-stone-900 border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {compareList.length > 0 && (
          <div id="floating-compare-bar" className="fixed bottom-16 sm:bottom-6 left-1/2 -translate-x-1/2 z-40 w-full max-w-2xl px-4">
            <div className="bg-amber-50 border-2 border-amber-400/80 backdrop-blur-md p-4 rounded-3xl shadow-xl flex flex-col gap-2">
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="bg-amber-400 text-stone-900 p-2 rounded-2xl hidden sm:block font-bold">
                    <Sparkles className="w-5 h-5" />
                  </div>
                  <div className="text-left">
                    <p className="text-xs font-extrabold text-stone-900 font-sans uppercase tracking-wider">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="bg-stone-900 hover:bg-stone-800 text-white font-sans font-bold text-xs px-4 py-2.5 rounded-xl cursor-pointer"
                  >
                    Compare Now
                  </button>
                  <button
                    ...
                    className="text-stone-500 hover:text-stone-900 p-2 transition-colors"
          ...
          <div id="compare-modal" className="fixed inset-0 bg-stone-900/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
            <div className="bg-white border border-stone-200 w-full max-w-4xl max-h-[90vh] rounded-3xl shadow-2xl overflow-y-auto flex flex-col">
              ...
              <div className="p-6 border-b border-stone-100 flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-sans font-extrabold text-stone-900 flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-amber-500" />
                    <span>Compare Camp Packages Side-by-Side</span>
                  </h3>
                  <p className="text-xs text-stone-500 mt-1">Review features and pricing elements to select the best vacation stay</p>
                </div>
                <button id="close-compare-x-btn" onClick={() => setShowCompareModal(false)} className="text-stone-500 hover:text-stone-800 p-2">
                  <X className="w-6 h-6" />
                </button>
              </div>
